...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<OvenScreenHandler> OVEN_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(AtlasMod.MOD_ID,"oven_screen_handler"),
                    new ExtendedScreenHandlerType<>(OvenScreenHandler::new, BlockPos.PACKET_CODEC));
